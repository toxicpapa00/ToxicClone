...
C_BOT_DESC = "Wᴇʟᴄᴏᴍᴇ 🤍🖤/nɪ’ᴍ ᴄʟᴏɴᴇᴅ ᴍᴜsɪᴄ & ᴠɪᴅᴇᴏ ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ/nɪ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴄʀᴇᴀᴛᴇ & ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ᴏᴡɴ ᴍᴜsɪᴄ ʙᴏᴛ ᴡɪᴛʜ ᴇᴀsᴇ ⚡/n✨ ғᴇᴀᴛᴜʀᴇs/n• ᴜɴʟɪᴍɪᴛᴇᴅ ʙᴏᴛ ᴄʟᴏɴɪɴɢ/n• ʜɪɢʜ-ǫᴜᴀʟɪᴛʏ ᴀᴜᴅɪᴏ/n• ғᴀsᴛ • sᴛᴀʙʟᴇ • ʟᴀɢ-ғʀᴇᴇ/n⚡ ᴡᴀɴᴛ ᴛᴏ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴍᴜsɪᴄ ʙᴏᴛ?/nᴠɪsɪᴛ » @SigmaBeatsBot 🚀/nᴍᴇᴇᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ » @isha_bots 🖤"
