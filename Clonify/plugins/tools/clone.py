...
C_BOT_DESC = "Wᴇʟᴄᴏᴍᴇ 🤍🖤/n/nɪ’ᴍ ᴄʟᴏɴᴇᴅ ᴍᴜsɪᴄ & ᴠɪᴅᴇᴏ ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ/n/nɪ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴄʀᴇᴀᴛᴇ & ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ᴏᴡɴ ᴍᴜsɪᴄ ʙᴏᴛ ᴡɪᴛʜ ᴇᴀsᴇ ⚡/n/n✨ ғᴇᴀᴛᴜʀᴇs/n• ᴜɴʟɪᴍɪᴛᴇᴅ ʙᴏᴛ ᴄʟᴏɴɪɴɢ/n/n• ʜɪɢʜ-ǫᴜᴀʟɪᴛʏ ᴀᴜᴅɪᴏ/n/n• ғᴀsᴛ • sᴛᴀʙʟᴇ • ʟᴀɢ-ғʀᴇᴇ/n/n⚡ ᴡᴀɴᴛ ᴛᴏ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴍᴜsɪᴄ ʙᴏᴛ?/n/n ᴠɪsɪᴛ » @SigmaBeatsBot 🚀/n/n ᴍᴇᴇᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ » @isha_bots 🖤"
